...
public class GuildWelcome {
     ...
     */
    public GuildWelcome(final String guildID, final @Nullable String description, final @Nullable String thumbnailURL,
                        final @Nullable String imageURL, final @Nullable String message) {

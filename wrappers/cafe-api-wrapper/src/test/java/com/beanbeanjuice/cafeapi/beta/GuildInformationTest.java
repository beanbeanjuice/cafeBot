...
public class GuildInformationTest {
    ...
    public void testGuildInformationAPI() {
        ...
        Assertions.assertEquals("!!", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getPrefix());
        Assertions.assertTrue(cafeAPI.GUILD.updateGuildInformation("816880157490675732", GuildInformationType.PREFIX, "beta!"));
        Assertions.assertEquals("beta!", cafeAPI.GUILD.getGuildInformation("816880157490675732").getPrefix());

        // Makes sure the moderator role ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getModeratorRoleID());
        ...
        Assertions.assertEquals("738590591767543921", cafeAPI.GUILD.getGuildInformation("816880157490675732").getModeratorRoleID());

        // Makes sure the twitch channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getTwitchChannelID());
        ...
        Assertions.assertEquals("856782983709458472", cafeAPI.GUILD.getGuildInformation("816880157490675732").getTwitchChannelID());

        // Makes sure the muted role ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getMutedRoleID());
        ...
        Assertions.assertEquals("856776166618300436", cafeAPI.GUILD.getGuildInformation("816880157490675732").getMutedRoleID());

        // Makes sure the live notifications role ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getLiveNotificationsRoleID());
        ...
        Assertions.assertEquals("858231567196618772", cafeAPI.GUILD.getGuildInformation("816880157490675732").getLiveNotificationsRoleID());

        // Makes sure notify on update is default and can be changed.
        Assertions.assertEquals(true, cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getNotifyOnUpdate());
        ...
        Assertions.assertEquals(false, cafeAPI.GUILD.getGuildInformation("816880157490675732").getNotifyOnUpdate());

        // Makes sure the update channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getUpdateChannelID());
        ...
        Assertions.assertEquals("645490120052703239", cafeAPI.GUILD.getGuildInformation("816880157490675732").getUpdateChannelID());

        // Makes sure the counting channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getCountingChannelID());
        ...
        Assertions.assertEquals("733203398337495041", cafeAPI.GUILD.getGuildInformation("816880157490675732").getCountingChannelID());

        // Makes sure the poll channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getPollChannelID());
        ...
        Assertions.assertEquals("359760149683896320", cafeAPI.GUILD.getGuildInformation("816880157490675732").getPollChannelID());

        // Makes sure the raffle channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getRaffleChannelID());
        ...
        Assertions.assertEquals("813817485014990860", cafeAPI.GUILD.getGuildInformation("816880157490675732").getRaffleChannelID());

        // Makes sure the birthday channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getBirthdayChannelID());
        ...
        Assertions.assertEquals("500658624109084682", cafeAPI.GUILD.getGuildInformation("816880157490675732").getBirthdayChannelID());

        // Makes sure the welcome channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getWelcomeChannelID());
        ...
        Assertions.assertEquals("857024885968732181", cafeAPI.GUILD.getGuildInformation("816880157490675732").getLogChannelID());

        // Makes sure the venting channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getVentingChannelID());
        ...
        Assertions.assertEquals("125227483518861312", cafeAPI.GUILD.getGuildInformation("816880157490675732").getVentingChannelID());

        // Makes sure the AI response status is default and can be changed.
        Assertions.assertEquals(false, cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getAiResponseStatus());
        Assertions.assertTrue(cafeAPI.GUILD.updateGuildInformation("816880157490675732", GuildInformationType.AI_RESPONSE, true));
        Assertions.assertEquals(true, cafeAPI.GUILD.getGuildInformation("816880157490675732").getAiResponseStatus());

        // Makes sure the daily channel ID is default and can be changed.
        Assertions.assertEquals("0", cafeAPI.GUILD.getAllGuildInformation().get("816880157490675732").getDailyChannelID());
        ...
        Assertions.assertEquals("606222472274116676", cafeAPI.GUILD.getGuildInformation("816880157490675732").getDailyChannelID());

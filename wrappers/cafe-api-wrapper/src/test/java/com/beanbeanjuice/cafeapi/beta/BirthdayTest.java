...
public class BirthdayTest {
    ...
    public void testBirthdaysEndpoint() throws ParseException {
        ...
        Assertions.assertEquals(31, cafeAPI.getBirthdaysEndpoint().getUserBirthday("178272524533104642").getDay());
        ...
        Assertions.assertEquals(BirthdayMonth.FEBRUARY, cafeAPI.getBirthdaysEndpoint().getUserBirthday("178272524533104642").getMonth());

        // Makes sure the changed day is the same.
        Assertions.assertEquals(29, cafeAPI.getBirthdaysEndpoint().getUserBirthday("178272524533104642").getDay());

        // Makes sure that alreadyMentioned is false by default.
        Assertions.assertFalse(cafeAPI.getBirthdaysEndpoint().getUserBirthday("178272524533104642").isAlreadyMentioned());
        ...
        Assertions.assertTrue(cafeAPI.getBirthdaysEndpoint().getUserBirthday("178272524533104642").isAlreadyMentioned());

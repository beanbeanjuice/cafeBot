...
public class GuildGoodbye {
     ...
     */
    public GuildGoodbye(final String guildID, @Nullable final String description, @Nullable final String thumbnailURL,
                        @Nullable final String imageURL, @Nullable final String message) {

...
* `remove-live-channel` - Remove the current live channel.
...
* `remove-update-channel` - Remove the current update channel.
...
* `remove-counting-channel` - Remove the current counting channel.
...
* `remove-poll-channel`- Remove the current poll channel.

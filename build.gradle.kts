...
allprojects {
    ...
    dependencies {
        ...
        implementation("tools.jackson.core:jackson-core:3.2.2") // https://mvnrepository.com/artifact/tools.jackson.core/jackson-core
        implementation("tools.jackson.core:jackson-databind:3.2.2") // https://mvnrepository.com/artifact/tools.jackson.core/jackson-databind

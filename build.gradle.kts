...
allprojects {
    ...
    dependencies {
        ...
        implementation("tools.jackson.core:jackson-core:3.1.4") // https://mvnrepository.com/artifact/tools.jackson.core/jackson-core
        implementation("tools.jackson.core:jackson-databind:3.1.4") // https://mvnrepository.com/artifact/tools.jackson.core/jackson-databind

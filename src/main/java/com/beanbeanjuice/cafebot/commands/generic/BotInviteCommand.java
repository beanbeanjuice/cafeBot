...
public class BotInviteCommand extends Command implements ICommand {
    ...
    private Button getInviteButton() {
        String URL = "https://discord.com/api/oauth2/authorize?client_id={BOT_ID}&permissions=8&scope=bot%20applications.commands";
        return Button.link(URL.replace("{BOT_ID}", bot.getSelfUser().getId()), "Invite")

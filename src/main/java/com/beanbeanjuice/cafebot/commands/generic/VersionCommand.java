...
public class VersionCommand extends Command implements ICommand {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        String version = versionMapping.map(OptionMapping::getAsString).orElse(cafeBot.getBotVersion());

        GitHubVersionEndpointWrapper githubVersionAPI = new GitHubVersionEndpointWrapper(cafeBot);

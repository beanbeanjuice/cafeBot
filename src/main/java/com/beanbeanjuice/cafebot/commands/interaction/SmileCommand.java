...
public class SmileCommand extends Command implements ICommand, ICommandInteraction {

    public SmileCommand(final CafeBot cafeBot) {
        super(cafeBot);
    }

    @Override
    public void handle(SlashCommandInteractionEvent event) {
        this.handleInteraction(InteractionType.SMILE, event, cafeBot);
    }

...
import com.beanbeanjuice.cafebot.utility.time.Time;
...
public class LogManager {
    ...
    public LogManager(CafeBot cafeBot, String name, String guildID, String logChannelID, String filePath) {
        ...
        Optional<String> logLevelString = Optional.ofNullable(EnvironmentVariable.CAFEBOT_LOG_LEVEL.getSystemVariable());
    ...
    public void log(@NotNull Class<?> c, @NotNull LogLevel logLevel, @NotNull String message,
        ...
        // Ignore debugs.
        if (!EnvironmentVariable.CAFEBOT_LOG_LEVEL.getSystemVariable().equals("DEBUG") && logLevel == LogLevel.DEBUG) return;
...
//        Logger logger = LoggerFactory.getLogger(c);
    ...
    public void logToGuild(Guild guild, MessageEmbed embed) {
        cafeBot.getCafeAPI().getCustomChannelApi().getCustomChannel(guild.getId(), CustomChannelType.LOG).thenAccept((customChannel) -> {

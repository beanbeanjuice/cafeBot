...
public enum LogLevel {
    ...
    DEBUG(Color.blue, "TEST", "TEST", "http://cdn.beanbeanjuice.com/images/cafeBot/log_level/debug.png"),
    LOADING(Color.orange, "LOADING", "LOAD", "http://cdn.beanbeanjuice.com/images/cafeBot/log_level/loading.gif"),
    OKAY(Color.green, "OKAY", "SUCC", "http://cdn.beanbeanjuice.com/images/cafeBot/log_level/okay.gif"),
    ERROR(Color.red, "ERROR", "ERR", "http://cdn.beanbeanjuice.com/images/cafeBot/log_level/error.webp"),
    INFO(Color.cyan, "INFO", "INFO", "http://cdn.beanbeanjuice.com/images/cafeBot/log_level/info.gif"),
    WARN(Color.orange, "WARN", "WARN", "http://cdn.beanbeanjuice.com/images/cafeBot/log_level/warn.gif");

...
/**
 * An {@link ISubCommand} used to set the {@link com.beanbeanjuice.utility.section.moderation.raffle.Raffle Raffle} {@link TextChannel TextChannel}.
 *
...
public class SetRaffleChannelSubCommand implements ISubCommand {
    ...
    public void handle(@NotNull SlashCommandInteractionEvent event) {
        ...
        if (event.getOption("raffle_channel") != null)
            channel = event.getOption("raffle_channel").getAsChannel().asTextChannel();
